...
switch ($_REQUEST["a"]) {
    ...
    case 'sb_transaction':
        if (!geoPC::is_ent()) {
            ...
            if (!isset($_REQUEST['page'])) {
                $_REQUEST['page'] = 0; //make default page = 0
            }
            ...
            case 6:
                ...
                if (($_REQUEST["c"]) && ($_REQUEST["z"])) {
                    ...
                    if (!$user_management->remove_current_ad($db, $_REQUEST["c"])) {
                        $user_management->site_error();
                    } elseif (!$user_management->verify_remove_success($db)) {
                            $user_management->site_error();
                    }
                    ...
                    case 2:
                        ...
                        if (is_numeric($_REQUEST["d"])) {
                            if (!$user_management->delete_ad_filter($_REQUEST["d"])) {
                                $user_management->site_error();
                            } elseif (!$user_management->display_all_ad_filters()) {
                                    $user_management->site_error();
                            }
                        } elseif (!$user_management->display_all_ad_filters()) {
                                $user_management->site_error();
    ...
    case 10:
        ...
        if (!$user_id) {
            ...
            } elseif (isset($_POST["b"]) && is_array($_POST["b"])) {
    ...
    case 28:
        ...
        if ($debug) {
            echo $_REQUEST["b"] . " is request b in extra page<BR>\n";
        }
