...
<div class="main listing_maincol">
	...
	<h2 class="title" style="margin-bottom: .5em;"><img src="{external file='images/icons/Newspaper-24_FFFFFF.png'}" alt="" />&nbsp;&nbsp;{$additional_text_1}
	...
	<div class="content_box_3 clearfix">
		...
		{if $offsite_videos_block}
			<div class="clear"></div>
			<h1 class="title" style="margin-top:5px;"><span class="glyphicon glyphicon-film"></span>&nbsp;{$offsite_videos_title}</h1>
