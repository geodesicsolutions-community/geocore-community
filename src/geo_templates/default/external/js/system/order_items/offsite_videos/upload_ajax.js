...
var geoVidProcess = {
    ...
    initSortableSlots : function () {
        ...
        jQuery('#offsite_videos_outer').sortable({
            ...
            stop: function (event, ui) {
                ...
                jQuery.post(
                    geoVidProcess.ajaxUrl + "?controller=OffsiteVideos&action=sortVideos",
                    {
    ...
    doSomething : function (what) {
        ...
        if (geoVidProcess.doingSomething('')) {
            ...
            if (geoVidProcess.debug) {
                alert('Attempting to do something ' + what + ' when already ' + geoVidProcess._inTransition);
            }
            return false;
        }
