...
var geoListing = {
	...
	init : function () {
		...
		jQuery('#buy_now_only').click(function() { geoListing.auctionTypeChange(true); });
		jQuery('#auction_type').change(function() { geoListing.auctionTypeChange(true); });
						...
						buttons: [
							 {
								...
								click: function () {jQuery('.cost-options-edit-form').submit();}
							 },
							 {
