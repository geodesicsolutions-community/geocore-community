	...
	<div class="listing_set list">
		{foreach $listings as $id=>$listing}
			{if $main_page_list_sub_template}
				{include file="main_page/$main_page_list_sub_template"}
			{else}
				<article class="listing {$listing.css}">
					{if $cfg.cols.image}
						<div class="image attention-getter-wrapper">
							...
							{else}
								<a href="{$cfg.listing_url}{$id}"{include file='system/browsing/common/popup_link.tpl'} style="position/ relative;">
