...
var addonNavigation = {
    init : function () {
        jQuery('.addonNavigation_regionSelect').change(function () {
            addonNavigation.selectObserve(this);});
        jQuery('.geographic_navigation_changeLink').click(function (event) {
            addonNavigation.changeRegionClick(this,event);});
    },
    ...
    selectObserve : function (element) {
        ...
        jQuery.post(
            'AJAX.php?controller=addon_geographic_navigation&action=selectRegion',
            {
                region_id: je.val(),
    ...
    changeRegionClick : function (element,event) {
        ...
        jQuery.post(
            'AJAX.php?controller=addon_geographic_navigation&action=chooseRegionBox',
    ...
    handleChangeBox: function (boxContents) {
        ...
        jQuery('.narrowRegionLink').click(function () {
            addonNavigation.changeChooseRegion(this);}).dblclick(function (event) {
                addonNavigation.changeDblClick(this,event);});
        jQuery('.narrowRegionSelect').change(function () {
            addonNavigation.changeChooseRegion(this);});
    },
