...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	function email_domains_form($db)
	{
		if ( geoPC::is_ent() )
		{
			...
			if (!$this->admin_demo()) $this->body .= "<div class=\"center\"><input type=submit name=\"auto_save\" value=\"Add To List\"></div>";
			$this->body .= "</div></fieldset>";
			$this->body .= "</form>";
			return true;
		}
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	function new_dropdown_form()
	{
		...
		$this->body .= "
				...
				if (!$this->admin_demo()) $this->body .= "<div class=\"center\"><input type=submit name=\"auto_save\" value=\"Add Dropdown\"></div>";
				$this->body .= "</div>
				</div>";
