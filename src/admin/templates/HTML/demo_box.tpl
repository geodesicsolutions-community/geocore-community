				...
				<form method="post" id="switch_theme" action="#" style="display: inline;">
					<div class="theme_dropdown">
						...
						<p style="white-space: normal; max-width: 300px;">
							<a href="https://geodesicsolutions.org/wiki/tutorials/design_adv/using_color_template_set/" onclick="window.open(this.href); return false;" style="color:blue;">How to apply color themes to your own site</a>
						</p>
					</div>
				</form>
			{/if}
