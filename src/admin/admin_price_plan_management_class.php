	...
	function price_plan_expiration_form($db,$price_plan_id=0)
	{
		...
		if ($price_plan_id)
		{
			...
			if ($price_plan_name)
			{
				...
				if (!$this->admin_demo())$this->body .= "<form action=index.php?mc=pricing&page=pricing_edit_plans&f=1&g=".$price_plan_id." class='form-horizontal form-label-left' method=post>\n";
...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	function lengths_form($price_plan_id=0,$category_id=0)
	{
		if ($price_plan_id)
		{
			...
			if (!$this->admin_demo()) $this->body .= "<td align=center>\n\t<input type=submit name=auto_save value=\"Save\">\n\t</td>\n";
			$this->body .= "</tr></tfoot>\n";
