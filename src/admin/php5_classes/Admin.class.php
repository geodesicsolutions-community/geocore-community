 ...
 */
    ...
    public function load_page()
    {
        ...
        } elseif ($adminLandingPage == 'checklist') {
        ...
        if (isset($page_data) && is_object($page_data)) {
            ...
            } elseif (isset($_GET['auto_save']) && !defined('DEMO_MODE')) {
	...
	' . $html;
        ...
        } elseif (isset($menu_category_data->filename) && $menu_category_data->filename != '') {
...
class menu_category
{
    ...
    public static function getMenuCategory($index, $create_new = true)
    {
        ...
        } elseif (!$create_new && !isset(self::$registry[$index])) {
            return false;
        }
