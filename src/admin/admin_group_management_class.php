	...
	function move_group_form($db,$group_id=0)
	{
		if ($group_id)
		{
			...
			elseif ($result->RecordCount() > 0)
			{
				...
				if (!$this->admin_demo()) $this->body .= "<div class='center'><input type=submit value=\"Save\" name='auto_save'></div>";
...
<fieldset>
	<legend>User Group Registration Specifics</legend><div>";
		...
		$this->body .= "<table>";
		if (!$this->admin_demo() && !$noSaveBtn)$this->body .= "<div class='center'><input type=submit name='auto_save' value=\"Save\"></div>";
		$this->body .= "<tr>\n\t<td colspan=2>\n\t
