...
class admin_extra_questions
{
    ...
    var $menu_loader;
// variable for the admin menu loader
    var $admin_site;
// variable for admin page
    var $html;
// variable for the html of the admin page
    var $db;
...
// class functions
    ...
    {
        if (!$this->admin_site->admin_demo()) {
            $html .= "<form action=index.php?page=new_dropdown method=post>\n";
        }
