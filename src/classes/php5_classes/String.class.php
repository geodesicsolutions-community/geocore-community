...
class geoString
{
    ...
    public static function convertCharset($string, $charset_from = null, $charset_to = null)
    {
        ...
        } elseif ($charset_from == 'UTF-8' && $charset_to == 'ISO-8859-1') {
            //Use utf8 decode
            $string = utf8_decode($string);
        } elseif ((defined('CLEAN_METHOD') && CLEAN_METHOD == 'mb_convert_encoding') || (!defined('CLEAN_METHOD') && function_exists('mb_convert_encoding'))) {
    ...
    public static function displayPrice($price, $pre = false, $post = false, $price_type = null)
    {
        ...
        if ($price == 0) {
            ...
            } elseif ($price_type === 'listing' && $db->get_site_setting('listing_replace_zero_cost')) {
