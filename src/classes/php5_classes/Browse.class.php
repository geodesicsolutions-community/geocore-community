...
class geoBrowse extends geoSite
{
	...
	public function commonBrowseData ($data, $text, $featured=false, $tabular=true)
	{
		...
		} else if ($data['item_type'] == 2 && (!$this->fields->auction_start->is_enabled  || $text['mixed_settings']['hide_entry_date_auction'])) {
		...
		} else if ($data['item_type'] == 2 && (!$this->fields->auction_time_left->is_enabled || $text['mixed_settings']['hide_time_left_auction'])) {
