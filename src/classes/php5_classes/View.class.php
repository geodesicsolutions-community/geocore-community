...
class geoView implements Iterator
{
    ...
    public function addTop($html, $forceTop = false)
    {
        if ($html) {
            if (
                !$forceTop && $this->useFooterJs && strpos($html, '<script') !== false
...
\$_COOKIE = " . var_export($_COOKIE, true) . "</pre>";
        ...
        if (
            defined('IN_ADMIN') || defined('IAMDEVELOPER') || $this->_alwaysShowTemplateError
    ...
    public function getCssHtml()
    {
        ...
        } elseif (isset($this->_css_files) && is_array($this->_css_files)) {
    ...
    public function __set($name, $value)
    {
        ...
        } elseif (is_array($value) && is_array($value)) {
