...
class geoListingFeed
{
    ...
    public function setFeedType($feedType)
    {
        ...
        switch ($feedType) {
            case geoListingFeed::RSS_FEED:
                ...
                if (!isset($this->tpl_file)) {
                    $this->tpl_file = 'rss_listings.tpl';
                }
    ...
    public function processListing($params, $smarty)
    {
        ...
        if ($this->imageUrl) {
        ...
        } elseif (($this->show['image'] && $this->imageCount != -1) || $this->leadImage) {
            ...
            if ($listing['image'] > 0 || $this->leadImage) {
                ...
                } elseif (isset($listing['image_id']) && $listing['image_id'] !== null) {
        ...
        if ($this->clean_description) {
            ...
            if (!$this->clean_all) {
                $listing['description'] = geoString::fromDB($listing['description']);
            }
