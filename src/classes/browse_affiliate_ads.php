...
//####################################################################################
    ...
    function display_browse_result($browse_result)
    {
        ...
        if ($browse_result->RecordCount() < 1) {
            ...
            if ($this->browse_type == 68) {
                $headers['entry_date']['reorder'] = 67;
            } elseif ($this->browse_type == 67) {
                $headers['entry_date']['reorder'] = 0;
            } else {
                $headers['entry_date']['reorder'] = 68;
            }
