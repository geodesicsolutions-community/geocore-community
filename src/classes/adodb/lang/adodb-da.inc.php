...
$ADODB_LANG_ARRAY = array (
  	    'LANG'                      => 'da',
            ...
            DB_ERROR_CONSTRAINT         => 'begr??nsning kr??nket',
            ...
            DB_ERROR_NOT_LOCKED         => 'ikke l??st',
            DB_ERROR_SYNTAX             => 'syntaksfejl',
            DB_ERROR_UNSUPPORTED        => 'ikke underst??ttet',
            DB_ERROR_VALUE_COUNT_ON_ROW => 'resulterende antal felter svarer ikke til foresp??rgslens antal felter',
            DB_ERROR_INVALID_DSN        => 'ugyldig DSN',
            DB_ERROR_CONNECT_FAILED     => 'tilslutning mislykkedes',
            0	                        => 'ingen fejl', // DB_OK
            DB_ERROR_NEED_MORE_DATA     => 'utilstr??kkelige data angivet',
            DB_ERROR_EXTENSION_NOT_FOUND=> 'udvidelse ikke fundet',
            DB_ERROR_NOSUCHDB           => 'database ikke fundet',
            DB_ERROR_ACCESS_VIOLATION   => 'utilstr??kkelige rettigheder'
);
