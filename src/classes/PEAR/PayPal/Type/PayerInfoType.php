...
class PayerInfoType extends XSDSimpleType
{
    ...
    function getEnhancedPayerInfo()
    {
        return $this->EnhancedPayerInfo;
    }
    function setEnhancedPayerInfo($EnhancedPayerInfo, $charset = 'iso-8859-1')
    {
        $this->EnhancedPayerInfo = $EnhancedPayerInfo;
        $this->_elements['EnhancedPayerInfo']['charset'] = $charset;
    }
}
