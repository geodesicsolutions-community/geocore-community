...
function AJAXErrorHandler($errno, $errstr, $errfile, $errline)
{
    ...
    */
    ...
    if (!defined('E_DEPRECATED')) {
        define('E_DEPRECATED', 8192);//constant added on PHP 5.3
    }
    if (!defined('E_USER_DEPRECATED')) {
        define('E_USER_DEPRECATED', 16384);//constant added on PHP 5.3
    }
