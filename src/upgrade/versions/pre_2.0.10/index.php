...
"; //needs to end with ;\n or the last query will not work.
        ...
        if (!$nochex_select_result) {
            ...
            if ("calculating" !== $this->state && !$manual_create_result) {
                echo "<br><font color=red>error in creating - geodesic_cc_manual_transactions</font><br>QUERY - $sql_query<BR>";
            }
        }
    ...
    function splitSqlFile(&$ret, $sql)
    {
        ...
        for ($i = 0; $i < $sql_len; ++$i) {
            ...
            } elseif ($char == ';' && ($i + 1 >= $sql_len || $sql[$i + 1] == "\n")) {
...
";
     ...
     */
    {
        ...
        if ($this->tableExists("geodesic_auctions_filters")) {
            ...
            } elseif (version_compare($oldVersion, "1.0.7", "==")) {
        ...
        if ($this->tableExists("geodesic_classifieds") && $this->tableExists("geodesic_logins") && !$this->tableExists("geodesic_auctions_bids")) {
            ...
            } elseif (version_compare($oldVersion, "2.0.5.2", "==")) {
